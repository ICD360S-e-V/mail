...
## v2.155.7 - 2026-07-21
#### Bug Fixes
- (**flatpak**) redirect gnome-keyring pkcs11 install into /app (#165) - (2d70a58) - icd360sevofficial, *claudeai*, *Claude Opus 4.7*

- - -

## v2.155.6 - 2026-07-21
#### Bug Fixes
- (**flatpak**) drop invalid -Dvapi=false gcr meson option (#164) - (4f32310) - icd360sevofficial, *claudeai*, *Claude Opus 4.7*
...
## v2.155.2 - 2026-07-20
#### Bug Fixes
- (**pgp**) fall back to decryptBytes + allowMalformed on UTF-8 FormatException (#160) - (1035eaf) - icd360sevofficial, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*

- - -

## v2.155.1 - 2026-07-20
#### Bug Fixes
- (**pgp**) log full exception surface when native decrypt fails (#159) - (a79767b) - icd360sevofficial, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*
...
## v2.153.2 - 2026-07-02
#### Bug Fixes
- (**viewer**) drop dead null-aware on email.subject (#146) - (a1fa1bf) - icd360sevofficial, *Claude Opus 4.7 (1M context)*, *Claude Opus 4.7 (1M context)*, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*
...
## v2.149.4 - 2026-06-28
#### Bug Fixes
- (**viewer**) add Download full message button when body was truncated (#124) - (16238f0) - icd360sevofficial, *Claude Opus 4.7 (1M context)*, *Claude Opus 4.7 (1M context)*, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*

- - -

## v2.149.3 - 2026-06-27
#### Bug Fixes
- (**ci**) move Android back to ubuntu-latest, keep Linux/Flatpak self-hosted (#123) - (d04995b) - icd360sevofficial, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*
...
## v2.147.1 - 2026-06-27
#### Bug Fixes
- (**cert**) populate per-account expiry map at restore + sweep fallback (#118) - (11538cb) - icd360sevofficial, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*

- - -

## v2.147.0 - 2026-06-27
#### Features
- (**cert**) daily mid-life refresh + block on permanent failure (#117) - (dba9019) - icd360sevofficial, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*
...
## v2.146.1 - 2026-06-20
#### Bug Fixes
- (**sentry**) defensive DSN validation, fall back when env value is malformed (#107) - (e6edf39) - icd360sevofficial, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*
...
## v2.144.4 - 2026-06-19
#### Bug Fixes
- (**ci**) swap checkout+download order in Publish Flatpak repo job (#92) - (8a63b84) - icd360sevofficial, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*
...
## v2.138.4 - 2026-05-25
#### Bug Fixes
- (**installer**) bundle crashpad_handler.exe so Windows app actually opens (#54) - (409a3ad) - icd360sevofficial, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*
...
## v2.136.7 - 2026-05-16
#### Bug Fixes
- (**update**) rotate version.json signing key after previous key was lost (#40) - (83ccb89) - icd360sevofficial, *ICD360S e.V.*, *Claude Opus 4.7 (1M context)*
...
## v2.135.1 - 2026-05-10
#### Bug Fixes
- use update_restore icon for reset (single circular arrow) - (1d23b38) - ICD360S e.V., *Claude Opus 4.6 (1M context)*
...
## v2.133.1 - 2026-05-09
#### Bug Fixes
- wrap TextBox decoration in WidgetStatePropertyAll - (386d472) - ICD360S e.V., *Claude Opus 4.6 (1M context)*

- - -

## v2.133.0 - 2026-05-09
#### Features
- add app name and member-only notice to lock screen - (9f6d246) - ICD360S e.V., *Claude Opus 4.6 (1M context)*
...
## v2.129.1 - 2026-05-08
#### Bug Fixes
- update copyright to 2025-current year with Gemeinnütziger Verein - (e569b3c) - ICD360S e.V., *Claude Opus 4.6 (1M context)*
...
## v2.125.5 - 2026-05-08
#### Bug Fixes
- remove 3 pointycastle imports orphaned by _encrypt/_decrypt removal - (82e48e8) - ICD360S e.V., *Claude Opus 4.6 (1M context)*

- - -

## v2.125.4 - 2026-05-08
#### Bug Fixes
- resolve final 6 flutter analyze warnings - (2f8bf7a) - ICD360S e.V., *Claude Opus 4.6 (1M context)*

- - -

## v2.125.3 - 2026-05-08
#### Bug Fixes
- resolve remaining 24 flutter analyze warnings - (884d479) - ICD360S e.V., *Claude Opus 4.6 (1M context)*
...
## v2.124.19 - 2026-05-07
#### Bug Fixes
- remove PGP crypto diagnostics from uploaded logs - (342379e) - ICD360S e.V., *Claude Opus 4.6 (1M context)*
...
## v2.108.0 - 2026-05-04
#### Security Fixes
- remove Cloudflare entirely, use Quad9-only for all DNS - (96423fd) - ICD360S e.V., *Claude Opus 4.6 (1M context)*
...
## v2.97.0 - 2026-05-04
#### Security Fixes
- eliminate master key String leak on heap (OWASP MASTG-TEST-0011) - (a3b03ff) - ICD360S e.V., *Claude Opus 4.6 (1M context)*
...
## v2.93.14 - 2026-05-04
#### Bug Fixes
- reduce timer frequency to prevent excessive battery drain on macOS - (ddc3215) - ICD360S e.V., *Claude Opus 4.6 (1M context)*
...
## v2.90.7 - 2026-04-28
#### Performance Improvements
- (**ci**) cache sodium native build hooks across runs - (1f6e9c3) - icd360sevofficial
...
## v2.89.9 - 2026-04-27
#### Bug Fixes
- (**security**) validate Authentication-Results authserv-id - (9bf3067) - icd360sevofficial

- - -

## v2.89.8 - 2026-04-27
#### Bug Fixes
- (**security**) remove MDN whitelist bypass in threat scoring - (09c0216) - icd360sevofficial
...
## v2.89.5 - 2026-04-27
#### Bug Fixes
- (**security**) try sodium first then legacy fallback for auth hash - (3cfd6b1) - icd360sevofficial
...
## v2.89.0 - 2026-04-26
#### Features
- (**security**) migrate vault to sodium (SecureKey + XChaCha20) - (cb35214) - icd360sevofficial
...
## v2.86.9 - 2026-04-26
#### Bug Fixes
- (**fork**) prevent SMTP injection and BCC leak in BDAT command - (3014ad9) - icd360sevofficial
...
## v2.86.6 - 2026-04-26
#### Bug Fixes
- (**security**) harden InAppWebView for legal pages - (751a301) - icd360sevofficial
...
## v2.86.0 - 2026-04-25
#### Features
- (**ui**) open Rechtliches links in InAppWebView dialog instead of external browser - (b229f10) - icd360sevofficial
...
## v2.79.0 - 2026-04-24
#### Features
- (**dns**) add lookupCaa, checkDnssec, lookupTlsa methods - (d54985c) - icd360sevofficial
...
## v2.76.1 - 2026-04-23
#### Bug Fixes
- close Tooltip parentheses on all 8 IconButtons - (1cb5883) - icd360sevofficial
...
## v2.73.0 - 2026-04-23
#### Features
- (**health**) add MTA-STS and TLS-RPT health checks - (8de451b) - icd360sevofficial
...
## v2.64.3 - 2026-04-22
#### Bug Fixes
- (**ui**) move notification bar from top to bottom - (d649ecd) - icd360sevofficial

- - -

## v2.64.2 - 2026-04-22
#### Performance Improvements
- (**pgp**) replace dart_pg isolate decrypt with native Go PGP - (f523358) - icd360sevofficial
...
## v2.63.2 - 2026-04-22
#### Bug Fixes
- (**compose**) real upload progress via addStream backpressure - (0bc68d4) - icd360sevofficial

- - -

## v2.63.1 - 2026-04-22
#### Bug Fixes
- (**smtp**) revert writeTextChunked in onServerResponse - (1a3aa34) - icd360sevofficial
...
## v2.55.0 - 2026-04-22
#### Features
- (**smtp**) onSendProgress callback for real-time upload speed - (ea7ba7a) - icd360sevofficial

- - -

## v2.54.0 - 2026-04-22
#### Features
- (**smtp**) add writeTextChunked for send progress tracking - (6252ab2) - icd360sevofficial
...
## v2.49.1 - 2026-04-18
#### Bug Fixes
- revert _encryptIsolate to OpenPGP.encryptBinaryData — internal API hangs on v6 keys - (bae5464) - icd360sevofficial
