...
// Kotlin 2.4 made the old `android { kotlinOptions { jvmTarget = … } }`
// DSL an error (was a deprecation warning in 2.x). Migrate to the new
// top-level `kotlin { compilerOptions { } }` block per kotl.in/u1r8ln.
kotlin {
    compilerOptions {
